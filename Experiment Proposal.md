...
## in my experiment, I'll be using audio recordings of each sentence - but I want to piece together the language of each
## sentence in case it's needed for a follow-up or needed elsewhere in the experiment.
